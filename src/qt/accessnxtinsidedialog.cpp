    ...
    model(0)
{
    ...
    ui->addressIn_AN->setPlaceholderText(tr("Enter a BitcoinDark address (e.g. 1CXYpEaefhA3G49TDKG7PiXGa67mHF4xRs)"));
#endif
    ...
    ui->addressIn_AN->setFont(GUIUtil::bitcoinAddressFont());
 }
...
void AccessNxtInsideDialog::setAddress_AN(const QString &address)
{
